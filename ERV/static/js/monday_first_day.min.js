...
!(function (a, b) {
  ...
  var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    pe = "Sij_Velj_Ožu_Tra_Svi_Lip_Srp_Kol_Ruj_Lis_Stu_Pro".split("_"),
    qe = "Sij_Velj_Ožu_Tra_Svi_Lip_Srp_Kol_Ruj_Lis_Stu_Pro".split("_"),
    re = be,
    se = be;
  U("Y", 0, 0, function () {
    var a = this.year();
  ...
  var ve = "Ned_Pon_Uto_Sri_Čet_Pet_Sub".split("_"),
    we = "Pon_Uto_Sri_Čet_Pet_Sub_Ned".split("_"),
    xe = "Pon_Uto_Sri_Čet_Pet_Sub_Ned".split("_"),
    ye = be,
    ze = be,
    Ae = be;
  U("H", ["HH", 2], 0, "hour"),
